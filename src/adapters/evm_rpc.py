...
class EvmRpcClient(JsonRpcClient):
  ...
  async def get_block(self, block_id: Union[int, str], full_transactions: bool = False) -> dict:
  ...
  async def get_block_by_hash(self, block_hash: str, full_transactions: bool = False) -> dict:
  ...
  async def verify_message(self, message: str, signature: str, expected_address: str) -> bool:
  ...
  def verify_signature(self, message_hash: str, signature: str, expected_address: str) -> bool:
  ...
  async def verify_transaction(self, tx_hash: str, expected_address: str) -> bool:
    ...
    try:
      ...
      return (
          ...
          receipt.get("status") == "0x1"  # 0x1 means success
      )
    except Exception:
      return False
